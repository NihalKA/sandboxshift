...
# Overwrite backend.tf with real bucket/table/region.
# The file in git is a local-backend placeholder — this overwrites it at
# runtime with the actual S3 backend. terraform.tfstate (if any) is migrated.
